...
int WinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR pCmdLine, int nCmdShow)
{
 ...
 GLFWwindow* window = glfwCreateWindow(500, 800, "Test_imgui_PDA", nullptr, nullptr);
 glfwSetWindowPos(window, 710, 140);
...
bool ret = LoadTextureFromFile("E:\\GUI_Test_PDA\\MyApplication\\examples\\example_glfw_vulkan\\image_cat_gui.jpg", &my_texture);
IM_ASSERT(ret);
